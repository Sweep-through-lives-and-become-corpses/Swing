...
import com.RealProject.dao.ClassDao;
import com.RealProject.dao.CourseDao;
import com.RealProject.dao.GradeDao;
import com.RealProject.dao.StudentDao;
import com.RealProject.model.CCourseModel;
import com.RealProject.model.ClassModel;
import com.RealProject.model.CourseModel;
import com.RealProject.model.GradeModel;
import com.RealProject.model.StudentModel;
...
public class CCourseAdd extends JDialog {
	...
	private void initialize() {
		...
		jLabel2 = new JLabel();
		jLabel2.setBounds(new Rectangle(261, 33, 75, 18));
		...
		jLabel = new JLabel();
		jLabel.setBounds(new Rectangle(96, 125, 180, 26));
		jLabel.setText("号学生已选课程包括：");
		this.setDefaultCloseOperation(DISPOSE_ON_CLOSE);

		this.setSize(600, 283);
		this.setModal(true);
		this.setLocationRelativeTo(null);
		this.setTitle("选课录入");
		jLabel3 = new JLabel();
		jLabel3.setBounds(new Rectangle(14, 211, 320, 26));
		jLabel3.setText("温馨提示：所选各门课程成绩互相独立。");

		jLabel5 = new JLabel();
		jLabel5.setBounds(new Rectangle(261, 73, 75, 18));
