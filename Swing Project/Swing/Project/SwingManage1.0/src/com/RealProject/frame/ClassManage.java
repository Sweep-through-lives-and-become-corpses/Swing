...
public class ClassManage extends JDialog {
	...
	private void initialize() {
		...
		jLabel_teach_sex.setBounds(new Rectangle(17, 71, 110, 26));
		jLabel_teach_name = new JLabel();
		jLabel_teach_name.setText("班级名称：");
		jLabel_teach_name.setBounds(new Rectangle(17, 25, 88, 28));
		jLabel_teach_educatioon = new JLabel();
		jLabel_teach_educatioon.setText("所属年级：");
		jLabel_teach_educatioon.setBounds(new Rectangle(245, 25, 90, 30));
		...
		this.setLocationRelativeTo(null);
			...
			jButton_cancel.setBounds(new Rectangle(347, 65, 70, 29));
			...
			jTextField_max_num.setBounds(new Rectangle(119, 69, 70, 28));
