...
import com.RealProject.dao.TeacherDao;
...
public class CourseManage extends JDialog {
	...
	private void initialize() {
		...
		jLabel_teach_name.setBounds(new Rectangle(253, 18, 75, 29));
		...
		jLabel1 = new JLabel();
		jLabel1.setBounds(new Rectangle(725, 71, 96, 31));
		jLabel1.setText("课程介绍：");
		jLabel = new JLabel();
		jLabel.setText("开课时间：");
		jLabel.setBounds(new Rectangle(250, 63, 80, 30));
		...
		this.setLocationRelativeTo(null);
			...
			jScrollPane.setBounds(new Rectangle(20, 71, 700, 250));
			jScrollPane.setViewportView(jTable);
			

			jTextField_course_info = new JTextArea();
			jTextField_course_info.setBounds(new Rectangle(725, 108, 167, 214));
			...
			jComboBox_teach_name.setBounds(new Rectangle(326, 18, 160, 30));


			jTextField_course_begin_time = new JTextField();
			jTextField_course_begin_time.setBounds(new Rectangle(330, 64, 160, 28));

					jPanel = new JPanel();
					jPanel.setLayout(null);
					jPanel.setBounds(new Rectangle(22, 332, 700, 106));
